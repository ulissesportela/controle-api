...
COMMENT ON COLUMN public.UND_FDRL.CD_UND_FDRL IS 'Código da Unidade Federal';
...
COMMENT ON COLUMN public.UND.IN_UND_ATV IS '1 = Sim,0 = Não';
...
COMMENT ON COLUMN public.USU_SIS.NR_PRFL IS 'FK tabela Perfil';
...
COMMENT ON COLUMN public.UND_USU_SIS.IN_UND_USU_SIS_ATI IS 'Ativo(1 =Sim ou 0=Não)';
